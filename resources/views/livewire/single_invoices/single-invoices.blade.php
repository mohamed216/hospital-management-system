                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mg-b-0 text-md-nowrap" style="text-align: center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select wire:model="insurance_id" class="form-control" wire:change="get_price1" id="exampleFormControlSelect1">
                                                <option value="">-- اختار التامين --</option>
                                        ...
                                        <td><input wire:model="discount_percentage" type="text" class="form-control" readonly></td>
