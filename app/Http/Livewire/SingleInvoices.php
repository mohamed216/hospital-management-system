...
class SingleInvoices extends Component
{
    ...
    public $price,$discount_percentage,$discount_value = 0 ,$patient_id,$doctor_id,$section_id,$type,$Service_id,$single_invoice_id,$insurance_id,$catchError;
    ...
    public function print($id)
    {
        ...
        return Redirect::route('Print_single_invoices',[
            ...
            'discount_percentage' => $single_invoice->discount_percentage,
    ...
    {
        $this->discount_percentage  = Insurance::where('id', $this->insurance_id)->first()->Company_rate;
    }
